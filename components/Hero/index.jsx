function Hero() {
  return (
    <>
      <section className="relative py-[120px]  px-5 lg:py-[180px]" id="home">
        <div className="container mx-auto flex items-center">
          <div className="mx-auto flex max-w-4xl flex-col items-center justify-center space-y-8 text-center">
            <h1 className="text-3xl font-extrabold text-gray-800 dark:text-white md:text-5xl">
              Free and Open-Source Next.js Template for Startup & SaaS
            </h1>

            <p className="text-lg font-medium text-gray-600 dark:text-body-color md:text-xl">
            ...
            <div className="flex flex-col gap-5 md:flex-row">
              <div>
                <button className="rounded-lg bg-blue-600 px-6 py-3 text-xl font-semibold text-white hover:bg-blue-700">
                  Download Now
                </button>
              </div>
              <div>
                <button className="rounded-lg bg-slate-600 px-6 py-3 text-xl font-semibold text-white hover:bg-slate-700">
                  Star on Github
                </button>
              </div>
            </div>
